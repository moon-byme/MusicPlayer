...
public class TesteReprodutorJavaFX {
    ...
    private static void carregarTodasMusicas() {
        ...
        long artistas = musicas.stream().map(Musica::getArtista).distinct().count();
    ...
    private static void listarTodasMusicas() {
        ...
        for (Musica m : musicas) {
            ...
            System.out.println("   " + count + ". " + m.getTitulo());
            count++;
        }
    ...
    private static void adicionarNaFila() {
        ...
        List<Musica> encontradas = reprodutor.buscarMusicasPorTitulo(busca);
        ...
        for (int i = 0; i < encontradas.size(); i++) {
            Musica m = encontradas.get(i);
            System.out.println((i + 1) + ". " + m.getArtista() + " - " + m.getTitulo());
        }
