...
public class CarregadorMusicasCompleto {
    ...
    private static List<Musica> carregarMusicasEmbutidas() {
        ...
        String[][] MUSICAS_POR_ARTISTA = {
                ...
                { "Bed Of Roses", "Its My Life", "Livin On A Prayer", "Runaway", "You Give Love A Bad Name" },
                { "Ceu Azul", "Como Tudo Deve Ser", "Dias De Luta, Dias De Gloria",
                 "Ela Vai Voltar", "Senhor Do Tempo" },
                { "21", "Camden", "Close To You", "I Love You, Im Sorry", "I Should Hate You" },
                { "Army Dreamers", "Babooshka", "Cloudbusting", "Running Up That Hill", "Wuthering Heights" },
                { "In The End", "What Ive Done" },
